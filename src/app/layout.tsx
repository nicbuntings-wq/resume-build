...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website",
    siteName: "Cyme",
    title: "Cyme — AI-Powered Resume Builder",
    description:
      "Create tailored, ATS-optimized resumes powered by AI. Land your dream tech job with personalized resume optimization.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Create tailored, ATS-optimized resumes powered by AI. Land your dream tech job with personalized resume optimization.",
    images: ["/og.webp"],
    creator: "@cyme_ai" // or remove if no handle yet
  },
  robots: {
    index: true,
    follow: true,
