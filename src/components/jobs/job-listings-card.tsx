...
// IMPORTANT: keep this in sync with JobListingParams filters on the server
type EmploymentType = 'full_time' | 'part_time' | 'co_op' | 'internship';

// Allow legacy `company_name` while rolling out `company`
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <SelectContent className="bg-white/90 backdrop-blur-xl border-white/40">
                    ...
                    {/* No "contract" here to match server filters */}
                  </SelectContent>
                </Select>
